...
import { Home, LineChart, LogOut, Package, PanelBottom, Settings, Settings2, ShoppingBag, Users, } from "lucide-react"
                ...
                <nav className="flex flex-col items-center gap-4 px-2 py-5">
                    <TooltipProvider>
                        ...
                        <TooltipTrigger asChild>
                            <Link href="#"
                                className="flex h-9 w-9 shrink-0 items-center justify-center rouded-lg text-muted-foreground transition-colors hover:text-foreground"
                            >
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent side="right"> Configuraçõesx </TooltipContent>
                    </Tooltip>
                    </TooltipProvider>
                </nav>
                    ...
                    <Sheet>
                        ...
                        <SheetContent side="left" className="sm:max-w-x">
                            <nav className="grid gap-6 text-lg font-medium">
                                ...
                                <Link
                                    href="#"
                                    className="flex items-center gap-4 px-2.5 text-muted-foregruoud
                                hover:text-foreground"
                                    prefetch={false}
                                >
                                    <Home className="h-5 w-5 trasition-all" />
                                    Início
                                </Link>
                                ...
                                hover:text-foreground"
                                    prefetch={false}
                                >
                                    <ShoppingBag className="h-5 w-5 trasition-all" />
                                    Pedidos
                                </Link>
                                ...
                                hover:text-foreground"
                                    prefetch={false}
                                >
                                    <Package className="h-5 w-5 trasition-all" />
                                    Produtos
                                </Link>
                                ...
                                hover:text-foreground"
                                    prefetch={false}
                                >
                                    <Users className="h-5 w-5 trasition-all" />
                                    Clientes
                                </Link>
                                <Link
                                    href="#"
                                ...
                                hover:text-foreground"
                                    prefetch={false}
                                >
                                    <Settings2 className="h-5 w-5 trasition-all" />
                                    Configurações
                                </Link>
                            </nav>
                        </SheetContent>
